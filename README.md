...
Applied biologically motivated thresholds for filtering
...
This assumption is explicitly documented and can be replaced with true patient-specific HLA calls (e.g., from OptiType or seq2HLA) without structural changes to the pipeline.
...
The following components are \*\*not implemented in the current version\*\* of the pipeline and represent clearly defined future extensions:



\- Patient-specific HLA typing (OptiType / seq2HLA)

\- Immunogenicity prediction using tools such as PRIME or DeepHLApan
